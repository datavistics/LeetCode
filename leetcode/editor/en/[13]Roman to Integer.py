...
s = Solution()
res = s.romanToInt(s="MCMXCIV")
print(res)

# Success:
# Runtime:40 ms, faster than 92.79% of Python3 online submissions.
# Memory Usage:14.1 MB, less than 81.63% of Python3 online submissions.
